...
- [x] Update list of previous workshops in `pages/previous_workshops.md` (i.e., add info and link of last year's DaMoN)
- [x] See the documentation of the [hugo-damon-db](https://github.com/damondb/hugo-damon-db) theme to learn about the available options/parameters and shortcodes.
- [x] Complete the checklist of the template repository (i.e. http://github.com/damondb/template-repo-damon-db)
...
2) Configure GitHub Pages under `Settings/Pages` (https://github.com/damon-db/2026/settings/pages):
